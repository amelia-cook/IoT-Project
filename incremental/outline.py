...
try:
    ...
    draw.text((430, 255), 'Get this shtuff done less ASAP', font = font24, fill = 0)
    draw.text((430, 20), 'Get this shtuff done ASAP', font = font24, fill = 0)
    draw.text((300,440), 'ip address', font = font18, fill = 0)
    #draw.text((10, 20), '7.5inch e-Paper', font = font24, fill = 0)
    #draw.text((150, 0), u'微雪电子', font = font24, fill = 0)
    #draw.line((20, 50, 70, 100), fill = 0)
    #draw.line((70, 50, 20, 100), fill = 0)
    draw.rectangle((10, 10, 400, 469), outline = 0)
    draw.rectangle((420, 10, 790,234), outline = 0)
    draw.rectangle((420, 244, 789, 469), outline = 0)
    draw.line((20,50, 390, 50 ), fill = 0) 
    draw.line((430, 50, 780, 50), fill = 0)
    draw.line((430, 285, 780,285), fill = 0)
